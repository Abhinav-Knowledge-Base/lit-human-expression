...
**Drama** is a specific mode of fiction represented in performance: a play, opera, mime, ballet, etc., performed in a theatre, or on radio or television.
...
- **Theatre of the Absurd:** Post-WWII movement focusing on the meaninglessness of human existence (e.g., Samuel Beckett).
- **Epic Theatre:** Developed by Bertolt Brecht,旨在 encourage the audience to think rather than just feel (The Alienation Effect).

## 3. Key Components
- **Dialogue & Monologue:** The primary means of unfolding the plot and character.
- **Stage Directions:** Instructions in the script for actors and directors.
